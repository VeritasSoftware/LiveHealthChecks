    ...
    <div className="App">
      ...
      { 
        triple(apis).map((api, i) => {
          return <div className="row"><div className="col-sm"><ApiWidget ApiName={api[0].ApiName} ReceiveMethod={api[0].ReceiveMethod} MyServerService={myServerService} MyHealthChecksRepository={myHealthChecksRepository} /></div>
          {api[1] != null ? <div className="col-sm"><ApiWidget ApiName={api[1].ApiName} ReceiveMethod={api[1].ReceiveMethod} MyServerService={myServerService} MyHealthChecksRepository={myHealthChecksRepository} /></div> : <div className="col-sm"></div>}
          {api[2] != null ? <div className="col-sm"><ApiWidget ApiName={api[2].ApiName} ReceiveMethod={api[2].ReceiveMethod} MyServerService={myServerService} MyHealthChecksRepository={myHealthChecksRepository} /></div> : <div className="col-sm"></div>}
          </div>
        })
      }      
    </div>
